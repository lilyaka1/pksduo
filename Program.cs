...
namespace WarehouseManagementSystem
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Создание складов
            Warehouse coldWarehouse = new Warehouse(1, "холодный", 1000, "ул. Холодная, 1");
            Warehouse sortingWarehouse = new Warehouse(2, "сортировочный", 1500, "ул. Центральная, 2");
            Warehouse generalWarehouse = new Warehouse(3, "общий", 2000, "ул. Складская, 3");
            Warehouse disposalWarehouse = new Warehouse(4, "утилизация", 500, "ул. Утилизации, 4");
        ...
        static void LoadTestData()
        {
            ...
            var generalWarehouse = warehouses.Find(w => w.Type == "общий");
            var coldWarehouse = warehouses.Find(w => w.Type == "холодный");
